...
using (HttpClient client = new HttpClient())
{
    try
    {
        string resposta = await client.GetStringAsync("https://raw.githubusercontent.com/andrelucas97/SistemaJogos/main/SistemaJogos/jsconfig1.json");
        var jogos = JsonSerializer.Deserialize<List<Partida>>(resposta)!;
...
╚═╝░░░░░╚═╝░░╚═╝╚══════╝╚═╝░░░░░╚═╝╚══════╝╚═╝╚═╝░░╚═╝╚═╝░░╚═╝╚═════╝░");
        ...
        void ExibirMenu()
        {
            ...
            menuExibido.Executar(jogos, perfil);
